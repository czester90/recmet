...
$settings = array(
     ...
     *
     * Default value: array containing 'User\Authentication\Adapter\Db' with priority 100
     * Accepted values: array containing services that implement 'User\Authentication\Adapter\ChainableAdapter'
     */
    'auth_adapters' => array( 100 => 'User\Authentication\Adapter\Db' ),
	 ...
	 *
	 * Default value: 'user/user/login.phtml'
...
return array(
    ...
    'service_manager' => array(
        'aliases' => array(
            ...
            'user_doctrine_em' => 'Doctrine\ORM\EntityManager',
        ),
    ),
);
